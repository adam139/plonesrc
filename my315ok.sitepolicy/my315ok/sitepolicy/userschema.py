...
class IKomUserDataSchema(IUserDataSchema):
    def getSchema():
        """
        """
...
class KomUserDataSchemaProvider(object):
    implements(IUserDataSchemaProvider)

    def getSchema(self):
        return IKomUserDataSchema
...
class KomUserDataPanelAdapter(UserDataPanelAdapter):
    pass
