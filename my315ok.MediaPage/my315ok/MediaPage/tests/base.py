...
def setup_product():
    ...
    import my315ok.MediaPage
    zcml.load_config('configure.zcml', my315ok.MediaPage)
    ...
    ztc.installPackage('my315ok.MediaPage')
...
setup_product()
ptc.setupPloneSite(products=['my315ok.MediaPage'])
